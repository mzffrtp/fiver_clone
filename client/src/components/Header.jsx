  ...
  return (
    <header className='p-5'>
      ...
      <nav className='flex font-medium gap-10 place-items-center'>
        ...
        <Link 
        to={"/register"}
        className='hover:text-green-500'>Sing In</Link>
        <Link
         to={"/login"}
        className='text-green-500 border border-green-500 p-1 rounded flex place-items-center hover:text-white hover:bg-green-500'>Join</Link>
      </nav>
    </div>
    </header>
